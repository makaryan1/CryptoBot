...
const defaultTranslations: Translations = {
  en: {
    ...
    // Exchange
    'exchange.connectExchangeApi': 'Connect Exchange API',
    'exchange.selectExchangeDescription': 'Select the exchange you want to connect',
    'exchange.connectToExchange': 'Connect to {exchange}',
    'exchange.connectApiDescription': 'Enter your API key and secret to connect your exchange account',
    'exchange.apiKey': 'API Key',
    'exchange.apiSecret': 'API Secret',
    'exchange.description': 'Description',
    'exchange.testnetMode': 'Testnet Mode',
    'exchange.useTestnetDescription': 'Use testnet for testing with virtual funds',
    'exchange.apiSecurityWarning': 'Important Security Notice',
    'exchange.apiSecurityDescription': 'Only provide read-only and trading permissions. Never provide withdrawal permissions.',
    'exchange.testConnection': 'Test Connection',
    'exchange.testing': 'Testing Connection...',
    'exchange.apiTestSuccess': 'Connection Successful',
    'exchange.apiTestSuccessDescription': 'Your API key has been verified and works correctly',
    'exchange.apiTestFailed': 'Connection Failed',
    'exchange.deleteApiKey': 'Delete API Key',
    'exchange.deleteApiKeyConfirm': 'Are you sure you want to delete this API key?',
    'exchange.noApiKeys': 'No API Keys Connected',
    'exchange.noApiKeysDescription': 'Connect your exchange API to start using trading bots',
    'exchange.yourApiKeys': 'Your API Keys',
    'exchange.addApiKey': 'Add API Key',
    'exchange.connectedOn': 'Connected on',
    'exchange.status': 'Status',
    'exchange.active': 'Active',
    'exchange.inactive': 'Inactive',
    'exchange.statusActive': 'API key is active and working correctly',
    'exchange.statusInactive': 'API key is inactive or has issues',
  ...
  ru: {
    ...
    'common.testConnection': 'Проверить соединение',
    ...
    // Exchange
    'exchange.connectExchangeApi': 'Подключение API биржи',
    'exchange.selectExchangeDescription': 'Выберите биржу, которую хотите подключить',
    'exchange.connectToExchange': 'Подключение к {exchange}',
    'exchange.connectApiDescription': 'Введите ваш API ключ и секретный ключ для подключения аккаунта биржи',
    'exchange.apiKey': 'API Ключ',
    'exchange.apiSecret': 'API Секретный ключ',
    'exchange.description': 'Описание',
    'exchange.testnetMode': 'Режим тестовой сети',
    'exchange.useTestnetDescription': 'Использовать тестовую сеть для тестирования с виртуальными средствами',
    'exchange.apiSecurityWarning': 'Важное уведомление о безопасности',
    'exchange.apiSecurityDescription': 'Предоставляйте только разрешения на чтение и торговлю. Никогда не предоставляйте разрешения на вывод средств.',
    'exchange.testConnection': 'Проверить соединение',
    'exchange.testing': 'Проверка соединения...',
    'exchange.apiTestSuccess': 'Соединение успешно установлено',
    'exchange.apiTestSuccessDescription': 'Ваш API ключ проверен и работает корректно',
    'exchange.apiTestFailed': 'Ошибка соединения',
    'exchange.deleteApiKey': 'Удалить API ключ',
    'exchange.deleteApiKeyConfirm': 'Вы уверены, что хотите удалить этот API ключ?',
    'exchange.noApiKeys': 'API ключи не подключены',
    'exchange.noApiKeysDescription': 'Подключите API вашей биржи, чтобы начать использовать торговых ботов',
    'exchange.yourApiKeys': 'Ваши API ключи',
    'exchange.addApiKey': 'Добавить API ключ',
    'exchange.connectedOn': 'Подключен',
    'exchange.status': 'Статус',
    'exchange.active': 'Активен',
    'exchange.inactive': 'Неактивен',
    'exchange.statusActive': 'API ключ активен и работает корректно',
    'exchange.statusInactive': 'API ключ неактивен или имеет проблемы',
    'exchange.testnet': 'Тестовая сеть',
